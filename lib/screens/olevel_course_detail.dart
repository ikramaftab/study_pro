...
class OlevelCourseDetailScreen extends StatefulWidget {
  const OlevelCourseDetailScreen({super.key});

  @override
  _OlevelCourseDetailScreenState createState() => _OlevelCourseDetailScreenState();
}

class _OlevelCourseDetailScreenState extends State<OlevelCourseDetailScreen> {
      ...
      child: ExpansionTile(
        ...
        children: [
          GestureDetector(
              ...
              child: _resourceTile("Notes", Icons.menu_book, Colors.blueAccent)),
          GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const PastPapersScreen()));
              },
              child: _resourceTile("Past Papers", Icons.description, Colors.orange)),
          GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const LecturesScreen()));
              },
              child: _resourceTile("Video Lectures", Icons.play_circle_fill, Colors.green)),
